...
import { ArrowLeft, Plus, X, Camera, Upload, Loader2 } from 'lucide-react';
        ...
        <div className="card p-4">
          ...
          {imageUrl ? (
            <div className="relative inline-block">
              <img src={assetUrl(imageUrl)} alt="小票" className="max-h-40 rounded-xl" />
              <button
                type="button"
                onClick={() => setImageUrl('')}
            ...
            <label className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-primary-300 transition-colors">
              {uploading ? (
